...
import 'package:healthy_sync/feature/lab/home/presentation/home/cubit/home_state.dart';
import 'package:healthy_sync/feature/lab/home/presentation/qr_scanner/screen/qr_scanner_screen.dart';
import 'package:healthy_sync/feature/lab/home/presentation/screens/lab_patient_details_screen.dart';
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "${LocaleKeys.lab.tr()} / ${profile['name']}",
                              style: TextStyles.font16DarkBlueW500.copyWith(
                                color: AppColor.black,
                              ),
                            ),
                        ...
                        return GestureDetector(
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    LabPatientDetailsScreen(patient: patient),
                              ),
                            );
                          },
